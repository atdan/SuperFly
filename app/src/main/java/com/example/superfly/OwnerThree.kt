...
import kotlinx.android.synthetic.main.fragment_sign_up.progress
import kotlinx.android.synthetic.main.owner_three.*

class OwnerThree : AppCompatActivity(),View.OnClickListener {
...
//            }
    ...
    private fun toSignUp(){
        val i = Intent(this, LandingOwnersActivity::class.java)
        startActivity(i)
    }
